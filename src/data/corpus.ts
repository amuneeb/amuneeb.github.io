...
export function buildCorpus(): Passage[] {
  const passages: Passage[] = [
    ...
    },
    {
      ...
      text: `Open to Principal and Staff AI engineering and applied AI roles. Based in ${profile.location}. Reachable by email at ${profile.email}, or on GitHub and LinkedIn.`,
